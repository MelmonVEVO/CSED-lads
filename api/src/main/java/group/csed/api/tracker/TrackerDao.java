...
public interface TrackerDao {
    ...
    void insert(@Bind("id") int id, @Bind("started") Date started, @Bind("lasted") int lasted, @Bind("cycleLength") int cycleLength);

    @SqlUpdate("UPDATE tracker SET started=:started, lasted=:lasted, cycle_length=:cycleLength WHERE id=:id")
    void update(@Bind("id") int id, @Bind("started") Date started, @Bind("lasted") int lasted, @Bind("cycleLength") int cycleLength);
